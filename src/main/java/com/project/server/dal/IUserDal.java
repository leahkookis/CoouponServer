...
public interface IUserDal extends CrudRepository<User, Long> {
    ...
    @Query("SELECT new com.sari.server.beans.UserDto(u.id, u. userName, u. password, u.userType, u.company.name) " +
    ...
    @Query("SELECT new com.sari.server.beans.SuccessfulLoginData(u.id, u.userType, u.company.id) " +
